...
public class QUserCategory extends EntityPathBase<UserCategory> {
    ...
    private static final long serialVersionUID = -1496135123L;
    ...
    public final com.mindshare.domain.user.embeddedkey.QUserCategoryId id;
    ...
    public QUserCategory(Class<? extends UserCategory> type, PathMetadata metadata, PathInits inits) {
        ...
        this.id = inits.isInitialized("id") ? new com.mindshare.domain.user.embeddedkey.QUserCategoryId(forProperty("id")) : null;
